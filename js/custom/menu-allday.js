    ...
    <div class="flex-container">
        <div class="menu-column">
            ...
            <div class="menu-section">
                ...
                <h4>FRESH SHUCKED OYSTERS<span>$18/34</span></h4>
                <p>CHAMPAGNE MIGNONETTE, HORSERADISH, LEMON, TABASCO (6 PC./12 PC.)</p>

                <h4>GARLIC ROASTED OYSTERS<span>$18</span></h4>
                <p>GARLIC PARMESAN BREADCRUMB, LEMON, (4 PC.)</p>

                <h4>TUNA TARTARE<span>$16</span></h4>
                <p>ARUGULA, SCALLION, SOY, SWEET CHILI PASTE, AVOCADO MOUSSE, CROSTINI</p>

                <h4>CRAB CAKE<span>$18</span></h4>
                <p>FRESH CORN-POBLANO RELISH, SRIRACHA AIOLI</p>

                <h4>JUMBO SHRIMP COCKTAIL (5)<span>$17</span></h4>
                <p>WASABI COCKTAIL SAUCE, GRILLED LEMON</p>

                <h4>POKE NACHOS<span>$19</span></h4>
                <p>WONTON CHIPS, AHI TUNA, FRESH CORN, DICED CUCUMBER, EDAMAME, SWEET SOY MARINADE, SRIRACHA AIOLI</p>
            </div>
            ...
            <div class="menu-section">
                ...
                <h4>GORGONZOLA BREAD<span>$7</span></h4>
                <p>TOASTED CIABATTA BREAD, WARM GORGONZOLA CREAM</p>
                ...
                <p>CRISPY CHICKEN WINGS, CARROT, CELERY AND BLUE CHEESE & YOUR CHOICE OF BUFFALO, HOT HONEY OR GARLIC PARMESAN</p>

                <h4>HOMEMADE HUMMUS PLATTER<span>$18</span></h4>
                <p>CHICKPEA HUMMUS, EGGPLANT-PEPPER RATATOUILLE, ROASTED RED PEPPER HUMMUS, GRILLED PITA</p>
            </div>
            ...
            <div class="menu-section">
                ...
                <h4>DOYLESTOWN SMASH<span>$19</span>></h4>
        ...
        <div class="menu-column">
            <!-- SHAREABLES -->
            <div class="menu-section">
                <h3 class="menu-header">SHAREABLES</h3>
                <h4>THE STATION FRIES<span>$14</span></h4>
                <p>BRAISED SHORT RIB GRAVY, CHEDDAR CHEESE CURD, STEAK FRIES</p>

                <h4>FIG RICOTTA CROSTINI<span>$16</span></h4>
                <p>FIG JAM, WHIPPED RICOTTA, PORK PROSCUITTO, HONEY-MINT DRIZZLE</p>

                <h4>SPICY MARYLAND CRAB DIP<span>$20</span></h4>
                <p>CREAMY CRAB DIP, DICED PEPPER, OLD BAY, WONTON CHIPS</p>

                <h4>MUSSELS & SAUSAGE<span>$16</span></h4>
                <p>P.E.I. MUSSELS SAUTEED WITH SPICY GROUND SAUSAGE, CHERRY TOMATO, WHITE WINE POMODORO</p>

                <h4>SHORT RIB FLATBREAD<span>$20</span></h4>
                <p>CARAMELIZED ONION, LEMON PARSLEY GREMOLATA, BLUE CHEESE, HORSERADISH AIOLI</p>

                <h4>CRISPY EGGPLANT CHIPS<span>$16</span></h4>
                <p>THIN SLICED FRIED EGGPLANT, OLIVE TAPENADE, BLACK GARLIC-ZA’ATAR SPICED AIOLI</p>
            ...
            <div class="menu-section">
                ...
                <h4>THE STATION CHICKEN<span>$26</span></h4>
                ...
                <h4>SEAFOOD CIOPPINO<span>$32</span></h4>
                <p>SAUTEED MUSSELS, CLAMS, SHRIMP, SALMON, WHITE FISH, FENNEL, POTATO, WHITE WINE TOMATO SAUCE</p>
